        ...
        $('rating').addEventListener('blur', function(e){
            switch (true) {
                case !this.value.trim():
                    ...
                    break;
                case this.value <= 0:
                    msgError('ratingMsg', 'Debe ingresar un número entre 1 y 10', e)
                    break;
        ...
        $('awards').addEventListener('blur', function(e){
            switch (true) {
                case !this.value.trim():
                    ...
                    break;
                case this.value <= 0:
                    msgError('awardsMsg', 'Debe ingresar un número entre 1 y 10', e)
                    break;
        ...
        $('length').addEventListener('blur', function(e){
            switch (true) {
                case !this.value.trim():
                    ...
                    break;
                    case this.value <= 59:
                    msgError('lengthMsg', 'Debe ingresar un número entre 60 y 360', e)
                    break;
                default:
                    break;
            };
...
// genero
        ...
        $('genre_id').addEventListener('blur', function(e){
            switch (true) {
                case !this.value.trim():
                    msgError("genreMsg","El genéro es obligatorio",e);
                    break;
                default:
                    break;
            };
        ...
        formAdd.addEventListener('submit', (e)=>{
            ...
            if($('rating').value == ""){
                errores.push('El campo calificación es obilgatorio');
            }else if($('rating').value <= 0) {
                errores.push('En el campo calificación debe ingresar un numero entre 1 y 10');
            }
            ...
            if($('awards').value == ""){
                ...
                errores.push('En el campo premio debe ingresar un número entre 1 y 10');
            }
